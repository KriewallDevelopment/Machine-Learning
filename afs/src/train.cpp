...
extern struct svm_parameter	globalParam;
extern struct svm_problem	globalProblem;
extern struct svm_model		globalModel;
...
struct svm_model train_main(int argc, char **argv)
{

	struct svm_model retVal;
